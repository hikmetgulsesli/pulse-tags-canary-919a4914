...
- Pulse Tags Canary turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page habits board called Pulse Tags Canary. It should show five habit chips, let the user toggle each chip between idle and done, persist state in localStorage, expose window.app with getState and reset methods, and include reset plus copy-summary controls. Keep it static HTML, CSS, and J…
...
- Record Operations - Pulse Tags Canary
- Record Editor - Pulse Tags Canary
- Status Board - Pulse Tags Canary
- Insights - Pulse Tags Canary

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Pulse Tags Canary
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Pulse Tags Canary
...
SCREEN_SPEC_3:
- exact_screen_title: Status Board - Pulse Tags Canary
...
SCREEN_SPEC_4:
- exact_screen_title: Insights - Pulse Tags Canary
